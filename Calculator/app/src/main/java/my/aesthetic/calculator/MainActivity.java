package my.aesthetic.calculator;
...
import my.aesthetic.calculator.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView pastcalculation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pastcalculation = findViewById(R.id.pastcalculation);
        display = findViewById(R.id.displaynumbers);
    ...
    public void equalBTNPush(View view)
    {
        ...
        pastcalculation.setText(userExp);
